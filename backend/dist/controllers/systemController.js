...
const getStatus = async (req, res) => {
    ...
    (0, response_1.sendSuccess)(res, { aiStatus: 'Operational', backend: 'Operational', db: 'Operational' }, 'System status retrieved');
};
...
const getRealtimeStatus = async (req, res) => {
    ...
    (0, response_1.sendSuccess)(res, { activeStreams: 4, messagesPerSecond: 12 }, 'Realtime metrics retrieved');
};
